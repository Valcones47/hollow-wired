...
- **Edit mode (KDE-style)**: right-click the bar (or pick "Edit mode" on the desktop menu) to drag the bar to another edge, click bar items to hide/show them, drag them to reorder, rearrange widgets and dock icons, and switch between ready-made layouts from a small, draggable floating tab. Esc or "Done" leaves it.
