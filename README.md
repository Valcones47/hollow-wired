...
- **Edit mode (KDE-style)**: right-click the bar (or pick "Edit mode" on the desktop menu) to drag the bar to another edge, click bar items to hide/show them, rearrange widgets and switch between ready-made layouts from a small floating tab. Esc or "Done" leaves it.
