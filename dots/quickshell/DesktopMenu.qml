...
PanelWindow {
    ...
    readonly property var items: [
        ...
        { icon: Theme.icons.palette, label: Theme.t("dmenu.wallpaper", "Trocar wallpaper"), keys: "",
          ...
          action: () => Quickshell.execDetached(["rice-waywallen-app"]) },
        { icon: Theme.icons.monitor, label: Theme.t("dmenu.static_wallpaper", "Usar uma imagem de fundo"), keys: "", enabled: true,
          action: () => Quickshell.execDetached(["rice-wallpaper-set"]) },
