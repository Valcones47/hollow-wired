    ...
    readonly property var bindCatalog: [
        ...
        },
        {
            ...
            binds: [
                ...
                { key: "Super + G", action: Theme.t("binds.act_quicknotes", "Bloco de Notas Rápido (QuickNotes)") },
                ...
                ColumnLayout {
                    ...
                    Flickable {
                        ...
                        ColumnLayout {
                            ...
                            // Lista em SettingsIndex.qml: a busca universal do launcher usa a mesma.
                            readonly property var navItems: SettingsIndex.entries
