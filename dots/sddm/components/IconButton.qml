...
Item {
    ...
    implicitWidth: preferredWidth !== undefined ? preferredWidth : (iconButton.showLabel && iconButton.label !== "" ? (buttonLabel.implicitWidth + iconButton.height + 30) : iconButton.height)
    width: preferredWidth !== undefined ? preferredWidth : implicitWidth
    height: iconSize * 2
    ...
    RowLayout {
        id: buttonContentRow
        anchors.fill: parent
        anchors.leftMargin: (iconButton.showLabel && iconButton.label !== "") ? 8 : 0
        anchors.rightMargin: (iconButton.showLabel && iconButton.label !== "") ? 10 : 0
        spacing: (iconButton.showLabel && iconButton.label !== "") ? 6 : 0

        Rectangle {
            id: iconContainer
            color: "transparent"
            Layout.preferredWidth: (iconButton.showLabel && iconButton.label !== "") ? parent.height : parent.width
        ...
        Text {
            id: dropdownArrow
            visible: iconButton.showLabel && iconButton.label !== ""
            text: "▾"
            font.pixelSize: iconButton.fontSize + 1
            color: iconButton.isActive ? iconButton.activeContentColor : iconButton.contentColor
            opacity: iconButton.enabled ? 0.75 : 0.3
